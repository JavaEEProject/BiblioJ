			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="idSession" title="${message(code: 'panier.idSession.label', default: 'Id Session')}" />
				...
				<g:each in="${panierInstanceList}" status="i" var="panierInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${panierInstance.id}">${fieldValue(bean: panierInstance, field: "idSession")}</g:link></td>
