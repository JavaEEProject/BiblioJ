	...
	<body>
		...
		<div id="show-panier" class="content scaffold-show" role="main">
			...
			<ol class="property-list panier">
				...
				<g:if test="${panierInstance?.idSession}">
				<li class="fieldcontain">
					<span id="idSession-label" class="property-label"><g:message code="panier.idSession.label" default="Id Session" /></span>
					
						<span class="property-value" aria-labelledby="idSession-label"><g:fieldValue bean="${panierInstance}" field="idSession"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${panierInstance?.livre}">
				<li class="fieldcontain">
					<span id="livre-label" class="property-label"><g:message code="panier.livre.label" default="Livre" /></span>
					
						<g:each in="${panierInstance.livre}" var="l">
